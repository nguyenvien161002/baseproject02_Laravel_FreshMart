        ...
        <div class="d-flex align-items-center">
            ...
            <div class="btn-group mx-2">
                ...
                <div class="dropdown-menu py-1">
                    <a class="dropdown-item py-1 px-3" href="{{URL::to('/admin/accounts/staffs?query=show&amount=10')}}{{isset($querySort) ? $querySort : ''}}">10</a>
                ...
                <th>
                    <div class="title-column">
                        ...
                        <div class="box-icon-sort d-flex ms-2">
                           <a href="{{URL::to('/admin/accounts/staffs?sortby=id&type=asc')}}{{isset($queryShowAmount) ? $queryShowAmount : ''}}"><i class="fa-solid fa-arrow-up sort-asc"></i></a>
                            <a href="{{URL::to('/admin/accounts/staffs?sortby=id&type=desc')}}{{isset($queryShowAmount) ? $queryShowAmount : ''}}"><i class="fa-solid fa-arrow-down sort-desc"></i></a>
                        </div>
                    </div>
                </th>
                <th>
                    <div class="title-column">
                        <p>Tên người dùng</p>
                        <div class="box-icon-sort d-flex ms-2">
                            <a href="{{URL::to('/admin/accounts/staffs?sortby=staff_name&type=asc')}}{{isset($queryShowAmount) ? $queryShowAmount : ''}}"><i class="fa-solid fa-arrow-up sort-asc"></i></a>
                            <a href="{{URL::to('/admin/accounts/staffs?sortby=staff_name&type=desc')}}{{isset($queryShowAmount) ? $queryShowAmount : ''}}"><i class="fa-solid fa-arrow-down sort-desc"></i></a>
                        </div>
                    </div>
                </th>
                <th>
                    <div class="title-column">
                        <p>Mật khẩu (MD5)</p>
                        <div class="box-icon-sort d-flex ms-2">
                            <a href="{{URL::to('/admin/accounts/staffs?sortby=password&type=asc')}}{{isset($queryShowAmount) ? $queryShowAmount : ''}}"><i class="fa-solid fa-arrow-up sort-asc"></i></a>
                            <a href="{{URL::to('/admin/accounts/staffs?sortby=password&type=desc')}}{{isset($queryShowAmount) ? $queryShowAmount : ''}}"><i class="fa-solid fa-arrow-down sort-desc"></i></a>
                        </div>
                    </div>
                </th>
                <th>
                    <div class="title-column">
                        <p>Phân quyềnh</p>
                        <div class="box-icon-sort d-flex ms-2">
                            <a href="{{URL::to('/admin/accounts/staffs?sortby=id_authorization&type=asc')}}{{isset($queryShowAmount) ? $queryShowAmount : ''}}"><i class="fa-solid fa-arrow-up sort-asc"></i></a>
                            <a href="{{URL::to('/admin/accounts/staffs?sortby=id_authorization&type=desc')}}{{isset($queryShowAmount) ? $queryShowAmount : ''}}"><i class="fa-solid fa-arrow-down sort-desc"></i></a>
                        </div>
                    </div>
                </th>
                <th width="200px">
