...
<div class="container-fluid">
    ...
    <div class="table-responsive">
        <form action="{{URL::to('admin/account/staff/update')}}" class="form-horizontal" method="post" enctype="multipart/form-data">
            @csrf
            <input type="hidden" name="id_account" value="{{ $account['id'] }}">
            <div class="mb-3 mt-3">
                <label for="staff_name">Tên người dùng:</label>
                <input type="text" class="form-control" value="{{ $account['staff_name'] }}" name="staff_name" required>
            </div>
            <div class="mb-3">
