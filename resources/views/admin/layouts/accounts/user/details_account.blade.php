...
<div class="container-fluid">
    ...
    <div class="header-table">
        ...
        <div class="box-addproduct">
            <a href="{{URL::to('admin/account/user/edit/' . $key['id'])}}" class="btn btn-outline-success">Chỉnh sửa</a>
            <a href="{{URL::to('admin/account/user/delete/' . $key['id'])}}" class="btn btn-outline-danger ms-1" onclick="return confirm('Bạn có thật sự muốn xóa ?');" type="button">Xóa</a>
        </div>
    </div>
        ...
        <div class="d-flex align-items-center">
            ...
            <div class="btn-group mx-2">
                ...
                <div class="dropdown-menu py-1">
                    <a class="dropdown-item py-1 px-3" href="{{URL::to('/admin/accounts/users?query=show&amount=4')}}{{isset($querySort) ? $querySort : ''}}">4</a>
    ...
    <div class="table-responsive">
        <div class="details__order">
            <div class="info-order w-50">
                ...
                <div class="group-order">
                    <label for="value_column">Tên người dùng: </label>
                    <span class="value_column">{{ $key['fullname'] }}</span>
                </div>
                <div class="group-order">
                    <label for="value_column">Email: </label>
                    <span class="value_column">{{ $key['email'] }}</span>
                </div>
                <div class="group-order">
