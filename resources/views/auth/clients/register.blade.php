...
<body>
    <div class="wrapper">
        <form action="{{URL::to('/register/account')}}" method="POST" name="form" autocomplete="off" class="form px-25px py-0" id="form-1">
            @csrf
            ...
            <div class="form-title {{Session::has('failed') ? 'mb-0' : ''}}">Đăng ký tài khoản Fresh Mart</div>
            ...
            <div class="form-group mb-5px">
                ...
                <input value="{{Session::get('fullname')}}" name="fullname" type="text" placeholder="Họ và tên của bạn" class="form-control" required>
                <span class="form-message"></span>
            </div>
            <div class="form-group mb-5px">
                <label for="email" class="form-label">Email:</label>
                <input value="{{Session::get('email')}}" name="email" type="text" placeholder="Email của bạn" class="form-control" required>
                <span class="form-message"></span>
            </div>
            <div class="form-group mb-5px">
                <label for="password" class="form-label">Mật khẩu</label>
                <input value="{{Session::get('password')}}" name="password" type="password" placeholder="Mật khẩu" class="form-control" required>
                <span class="form-message"></span>
            </div>
            <div class="form-group mb-5px">
                <label for="confirm_password" class="form-label">Nhập lại mật khẩu</label>
                <input value="{{Session::get('confirm_password')}}" name="confirm_password" type="password" placeholder="Nhập lại mật khẩu" class="form-control" required>
                <span class="form-message"></span>
            </div>
