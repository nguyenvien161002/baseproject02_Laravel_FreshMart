...
<head>
    ...
    <title>Đăng nhập nhân viên | Fresh Mart</title>
...
<body>
    <div class="wrapper login-account">
        <form action="{{URL::to('/login/staff')}}" method="POST" name="form" autocomplete="off" class="form" id="form-1">
            @csrf
            ...
            <div class="form-title">Đăng nhập nhân viên Fresh Mart</div>
            <div class="spacer">
            ...
            <div class="form-group">
                ...
                <input value="{{Session::has('staff_name') ? Session::get('staff_name') : '' }}" name="username" value="" type="text" placeholder="Họ và tên của bạn" class="form-control" required>
